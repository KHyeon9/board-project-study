...
class JpaRepositoryTest {
    ...
    void givenTestData_whenSelecting_thenWorksFine() {
        ...
        assertThat(articles)
                .isNotNull()
                .hasSize(102); // classpath:resources/data.sql 참조
    }
    ...
    void givenTestData_whenUpdating_thenWorksFine() {
        ...
        Hashtag updatedHashtag = Hashtag.of("UpdateHashtag");
        ...
        // Then
        assertThat(saveArticle.getHashtags()).hasSize(1)
    ...
    @Test
    void givenHashtagNamesAndPageble_whenQueryingArticles_thenReturnArticlePage() {
        // Given
